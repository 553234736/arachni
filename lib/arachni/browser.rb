...
EOJS
    ...
    def capabilities
      Selenium::WebDriver::Remote::Capabilities.Chrome(
        ...
        "chrome.page.settings.userAgent" => USER_AGENT,
        "chrome.page.customHeaders.X-Arachni-Browser-Auth" => auth_token,
        "chrome.page.settings.resourceTimeout" => Options.http.request_timeout,
        "chrome.page.settings.loadImages" => !Options.browser_cluster.ignore_images,
      )
    end
