    ...
    module Parts
      ...
      module Browser
        ...
        def handle_browser_page(result, *)
          ...
          synchronize do
            return unless push_to_page_queue page
